---
title: 'End-to-end Dummy E-Commerce Data Pipeline'
dateUpload: 'September 15 2024'
topics: Data Engineering,Data Warehouse
projectURL: https://github.com/naufalbasara/superstores-pipeline
---
...
**Stacks**: Apache Airflow for Data Orchestration, Postgres for DB, Python for ETL
...
Data culminates within operational database then will be extracted to gain some insights in the data. Furthermore, dashboard will be developed for some business users to keep their situation or condition acquaintance of the related units within company still remain.

## Data Environment
Data environment are the existing condition regarding data within the company that covers operational database and data warehouse.
...
<img width="1258" alt="image" src="https://github.com/user-attachments/assets/7514f38f-2730-483b-b3fa-39442f7f0db4"></img>

### Load Dimension Tables to Staging DB DAG
<img width="684" alt="image" src="https://github.com/user-attachments/assets/d20cc2e5-5235-4d66-82e8-05b36cf3d88a"></img>

### Load Fact Tables to Staging DB DAG
<img width="656" alt="image" src="https://github.com/user-attachments/assets/3b384cf0-6295-4f35-9844-2aff3740ce19"></img>
